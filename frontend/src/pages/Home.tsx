    ...
    <div className="min-h-full flex flex-col items-center justify-center px-6 py-16">
      <div className="max-w-2xl w-full">
        ...
        <a
          ...
          className="block w-full text-center bg-[var(--color-steam-blue)] hover:bg-blue-500 transition py-3 px-6 rounded-lg text-white font-semibold mb-4"
        >
          通过 Steam 登录
        </a>

        <div className="flex items-center gap-3 my-6 text-slate-500 text-sm">
